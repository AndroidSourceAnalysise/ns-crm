...
//            String http_secret_key)
        ...
        String[] trackerServers = propKit.get("tracker_server").split(",");
        ClientGlobal.init(propKit.getInt("connect_timeout"),
                propKit.getInt("network_timeout"),
                propKit.get("charset"), trackerServers,
                propKit.getInt("http.tracker_http_port"),
                propKit.getBoolean("http.anti_steal_token",false), propKit.get("http_secret_key"));
    }
