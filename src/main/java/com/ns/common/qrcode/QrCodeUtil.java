...
public class QrCodeUtil {
    ...
    private static BufferedImage createImage(String content, String imgPath, boolean needCompress) throws Exception {
        ...
        hints.put(EncodeHintType.MARGIN, 0);//0-4  白边宽度
     ...
     * @throws Exception
     */
    public static String encodeBase64(String content,String imgPath,String format,boolean needCompress) throws Exception {
        BufferedImage image = QrCodeUtil.createImage(content, "", needCompress);
        return new String(Base64.encodeBase64(imageToBytes(image,format)));
    }
